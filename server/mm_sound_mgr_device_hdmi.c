...
#define HDMI_AUDIO_CHANNEL_POPUP_DESTROYED_PATH		"/hdmisyspopup/dbus_handler"
#define HDMI_AUDIO_CHANNEL_POPUP_DESTROYED_INTERFACE  "com.samsung.hdmisyspopup.signal"
#define HDMI_AUDIO_CHANNEL_POPUP_DESTROYED_SIGNAL	"hdmisyspopup_term"
