...
typedef enum
{
	...
	SUBSESSION_RINGTONE,
	SUBSESSION_MEDIA,
	SUBSESSION_VOICE_ANSWER_PLAY,
	SUBSESSION_VOICE_ANSWER_REC,
	SUBSESSION_INIT,
	SUBSESSION_VR_NORMAL,
	SUBSESSION_VR_DRIVE,
	SUBSESSION_RECORD_STEREO,
	SUBSESSION_RECORD_STEREO_FOR_INTERVIEW,    /* directional recording mode for interview */
	SUBSESSION_RECORD_STEREO_FOR_CONVERSATION, /* directional recording mode for conversation */
